    ...
    <div className="min-h-screen pb-[100px] text-white p-4 md:p-8 font-sans">
      ...
      <div className="flex flex-col md:flex-row items-center md:justify-between mb-6 space-y-4 md:space-y-0 bg-black-100 p-6 rounded-lg shadow-md">
        <div className="flex items-center space-x-3">
          <img
            src="https://th.bing.com/th/id/OIP.mzHrHGZ3VedhnS1Kqlc0vQHaEK?w=295&h=180&c=7&r=0&o=5&dpr=1.3&pid=1.7" // Replace with actual profile image URL
            alt="Profile"
            className="w-16 h-16 md:w-20 md:h-20 rounded-full border-2 border-gray-500 shadow-lg"
          />
          <div className="text-center md:text-left">
            <h1 className="text-2xl font-bold leading-tight">BITCOIN IS PUMPING</h1>
            <p className="text-gray-400 text-sm md:text-base">@YOU ARE OG BRO !!!</p>
            <p className="text-gray-500 text-xs md:text-sm">@0xcBe60034...0CDCcD</p>
          </div>
        </div>
        <div className="text-center md:text-right">
          <p className="text-gray-400 text-sm md:text-base">Account balance:</p>
          <p className="text-2xl font-bold text-primary-500 tracking-wide">0 BUZZ</p>
        </div>
      </div>
        ...
        <button
          className={`pb-2 font-semibold transition ${
            selectedTab === 'Activities'
              ? 'text-white border-b-2 border-pritext-primary-500'
        ...
        <table className="w-full text-left table-auto text-xs md:text-sm">
          ...
          <tbody>
            <tr className="border-b border-gray-700 text-gray-300 hover:bg-gray-800 transition">
              ...
              <td className="px-2 py-3 text-primary-500 font-semibold">100 BUZZ</td>
              <td className="px-2 py-3">5000</td>
              <td className="px-2 py-3">4900</td>
              <td className="px-2 py-3 text-primary-500 font-semibold">50 BUZZ</td>
          ...
          {[1].map((page) => (
            <button
              ...
              className={`py-1 px-3 rounded-lg font-semibold ${
                page === currentPage ? 'bg-primary-500 text-white' : 'text-gray-400 hover:text-gray-200'
              } transition`}
