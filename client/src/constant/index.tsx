...
export const exploreCoins = [
  ...
  },
  {
    ...
    description: "A utility token that allows you to pay for services on the Binance exchange.",
  },
  {
    id: 4,
    name: "DogeCoin",
    ...
    description: "A fun and friendly internet currency that has grown to become a popular digital currency.",
  },
  {
    id: 5,
    name: "Solana",
    ...
    description: "A fast, secure, and censorship-resistant blockchain providing the open infrastructure required for global adoption.",
  },
  {
    id: 6,
    name: "PePe",
    ...
    description: "A decentralized meme token that grew into a vibrant ecosystem of projects and communities.",
  },
  {
    id: 7,
    name: "Shiba Inu",
  ...
  },
  {
    ...
    description: "A peer-to-peer electronic cash system that aims to be a global payment system.",
  },
  {
    id: 9,
    name: "UniSwap",
    ...
    description: "A decentralized finance protocol that is used to exchange cryptocurrencies without the need for a centralized intermediary.",
  },
  {
    id: 10,
    name: "FlokiInu",
